...
This challenge probably took me like 10 hours, not counting the time it took to browse CSS libraries (an endless rabbit hole of possibilites)

I didn't encounter any problems that were particularly noteworthy. I think maybe a demo of some cool sites from other students as an example would have helped me get started sooner with what I wanted to do but that's more of a want than a need.
